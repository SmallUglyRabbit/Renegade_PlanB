...
{ 
	...
	public class StoryScript7 : MonoBehaviour
	{
		...
		void OnTriggerEnter2D(Collider2D other)
		{
			...
			{
				PlayerTalk.text = "{fade}Why is there so much blood?{/fade} ";
				ParasiteTalk.text = "This is the liquification process, to rebuild our bodies.";
		...
		private void StopTalking()
		{
			...
			GlobalsScript.StoryFlagsArray[7] = true; //Changes the first story flag to false.
