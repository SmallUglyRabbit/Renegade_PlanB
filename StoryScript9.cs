...
{ 
	...
	public class StoryScript9 : MonoBehaviour
	{
		...
		void OnTriggerEnter2D(Collider2D other)
		{
			...
			{
				PlayerTalk.text = "Why are there so many dead people down here";
				ParasiteTalk.text = "My people are gathering your bodies for the 'reunification'";
		...
		private void StopTalking()
		{
			...
			GlobalsScript.StoryFlagsArray[9] = true; //Changes the first story flag to false.
