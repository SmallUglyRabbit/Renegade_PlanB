...
{ 
	...
	public class StoryScript20 : MonoBehaviour
	{
		...
		void OnTriggerEnter2D(Collider2D other)
		{
			...
			{
				PlayerTalk.text = "How can you do this?";
				ParasiteTalk.text = "I am ruler of seven systems, I will do as I wish. Now walk to that machine.";
		...
		private void ONDONE()
		{
			...
			this.Delay(7,StopTalking);
		}
	
		private void StopTalking()
		{
			//TheTrigger.SetActive(false);
			GlobalsScript.StoryFlagsArray[20] = true; //Changes the first story flag to false.
