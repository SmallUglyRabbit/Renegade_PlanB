...
{ 
	...
	public class StoryScript8 : MonoBehaviour
	{
		...
		void OnTriggerEnter2D(Collider2D other)
		{
			...
			{
				PlayerTalk.text = "{fade}So what are you?{/fade} ";
				ParasiteTalk.text = "I'm not from this world.";
				this.Delay(5, ONDONE);
			}
		}
		private void ONDONE()
		{
			PlayerTalk.text = "An Alien?";
			ParasiteTalk.text = "Something like that. Watch your step, we are both in here now. ";
